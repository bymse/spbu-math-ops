...
namespace MathOps.Tests.MultiDimensional
{
        ...
        : ExecutorTestBase<TwoDimensionalApproximateResult, NelderMeadMethodIteration>
    {
        ...
        private static readonly IReadOnlyList<Vector2> StartVertexes = new[]
        {
            new Vector2(8, 9),
            new Vector2(10, 11),
            new Vector2(8, 11),
        ...
        protected override IReadOnlyList<NelderMeadMethodIteration> ExpectedIterationsList => new[]
        {
            new NelderMeadMethodIteration
            {
                ...
                SecondMaxValueVertex = new Vector2(8, 11),
            ...
            new NelderMeadMethodIteration
            {
                ...
                SecondMaxValueVertex = new Vector2(8, 9),
            ...
            new NelderMeadMethodIteration
            {
                ...
                SecondMaxValueVertex = new Vector2(4, 8),
            ...
            new NelderMeadMethodIteration
            {
                ...
                MinValueVertex = new Vector2(4, 6),
                SecondMaxValueVertex = new Vector2(4, 7),
            ...
            new NelderMeadMethodIteration
            {
                ...
                SecondMaxValueVertex = new Vector2(4, 6),
            ...
            new NelderMeadMethodIteration
            {
                ...
                SecondMaxValueVertex = new Vector2(5, 6.75M),
            ...
            new NelderMeadMethodIteration
            {
                ...
                SecondMaxValueVertex = new Vector2(5, 6.5M),
